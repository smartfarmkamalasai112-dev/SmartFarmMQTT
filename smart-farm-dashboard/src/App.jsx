      ...
      <div className="min-h-screen bg-slate-100 text-slate-800 font-sans">
        ...
        <main className="max-w-5xl mx-auto p-4 pt-6 pb-20">
          <Routes>
            ...
            <Route path="/control" element={<ControlPage displayData={displayData} onToggleRelay={handleToggleRelay} onToggleMode={handleToggleMode} onSaveConfig={handleSaveConfig} />} />
